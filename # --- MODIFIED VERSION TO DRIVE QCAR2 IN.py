...
def setup(qlabs, initialPosition = [-1.205, -0.83, 0.005], initialOrientation = [0, 0, -44.7]):
    ...
    WAYPOINTS = [ (-0.654,-1.041,-15),(-0.388,-1.061,0),(-0.035,-1.071,0),(0.595,-1.065,0),(1.236,-1.065,-10),(1.559,-1.028,-10),(2.202,0.123,-10),(2.198,2.058,0),
                 (2.202,3.785,0),(1.957,4.237,0),(1.639,4.389,0),(0.599,4.390,-10)]
    #(-1.205, -0.83, -7),
    #(-1.0, -0.4, -2),
    #(-0.5, 0.1, -5),
    #(0.3, 0.8, -5),
    ...
    def move_to_waypoint(qcar, heading_deg, speed=0.5, duration=1.5):
...
# move through each waypoint
    for x, y, heading in WAYPOINTS:
        move_to_waypoint(hQCar2, heading, speed=0.2, duration=3)

    hQCar2.set_velocity_and_request_state(forward=0, turn=0)
